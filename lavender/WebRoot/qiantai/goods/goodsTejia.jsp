							                  ...
							                  <TABLE onmouseover="this.style.backgroundColor='#FF6600'" onmouseout="this.style.backgroundColor=''" border=0 cellSpacing=1 cellPadding=2 width=98 bgColor=#e1e1e1 align=center height=100>
							                    <TR>
							                      <TD bgColor=#ffffff  align=left>
							                        <P align="center">
							                           <A href="<%=path %>/goodsDetailQian.action?id=${goods.id }"><IMG border=0 align=absMiddle src="<%=path %>/${goods.fujian }" width=169 height=141></A>
							                           <center>
							                              <A href="<%=path %>/goodsDetailQian.action?id=${goods.id }"><FONT color=#ff0000></FONT>${goods.mingcheng }</A>
							                              <br/>
							                                                                                            原价:${goods.jiage }&nbsp;&nbsp;特价:${goods.tejia }
							                           </center>
							                        </P>
							                      </TD>
							                    </TR>
